...
public class DummyConnectionPlugin implements IConnectionPlugin {

  private static final transient Logger LOGGER = Logger.getLogger(DummyConnectionPlugin.class.getName());
