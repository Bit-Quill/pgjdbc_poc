...
public interface ITopologyService {
   ...
   */
  void setClusterInstanceTemplate(HostSpec clusterInstanceTemplate);
   ...
   */
  List<HostSpec> getTopology(Connection conn, boolean forceUpdate);
   ...
   * null.
   */
  @Nullable List<HostSpec> getCachedTopology();
   ...
   */
  @Nullable HostSpec getLastUsedReaderHost();
   ...
   */
  void setLastUsedReaderHost(@Nullable HostSpec reader);
   ...
   */
  void addToDownHostList(@Nullable HostSpec downHost);
   ...
   *             down hosts
   */
  void removeFromDownHostList(HostSpec host);
