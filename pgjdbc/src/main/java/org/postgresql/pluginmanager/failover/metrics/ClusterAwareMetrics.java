...
/**
 * Collect certain performance metrics for {@link org.postgresql.pluginmanager.failover.FailoverConnectionPlugin}.
 *
 ...
 * reconnect to an appropriate instance.
 */
public class ClusterAwareMetrics {
  ...
  /**
   * Registers whether a failover procedure successfully reconnected
   *
