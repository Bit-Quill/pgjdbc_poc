...
public class ConnectionPluginManager {
  ...
  /**
   * Initialize a chain of {@link IConnectionPlugin} using their corresponding
   * {@link IConnectionPluginFactory}.
   ...
   */
  public void init(ICurrentConnectionProvider currentConnectionProvider, Properties props)
