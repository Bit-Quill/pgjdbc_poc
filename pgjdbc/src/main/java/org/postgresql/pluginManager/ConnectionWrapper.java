...
public class ConnectionWrapper implements Connection, ICurrentConnectionProvider {

  private static final transient Logger LOGGER = Logger.getLogger(ConnectionWrapper.class.getName());
  ...
  public ConnectionWrapper(BaseConnection connection, HostSpec[] hostSpecs, Properties props, String url) throws SQLException  {
  ...
  public void setAutoCommit(boolean autoCommit) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setAutoCommit(autoCommit); return null; });
  }
  ...
  public void commit() throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.commit",
        () -> { this.currentConnection.commit(); return null; });
  }
  ...
  public void rollback() throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.rollback",
        () -> { this.currentConnection.rollback(); return null; });
  }
  ...
  public void close() throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.close",
        () -> { this.currentConnection.close(); return null; });
  }
  ...
  public void setReadOnly(boolean readOnly) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setReadOnly(readOnly); return null; });
  }
  ...
  public void setCatalog(String catalog) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setCatalog(catalog); return null; });
  }
  ...
  public void setTransactionIsolation(int level) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setTransactionIsolation(level); return null; });
  }
  ...
  public synchronized void clearWarnings() throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.clearWarnings(); return null; });
  }
  ...
  public void setTypeMap(Map<String, Class<?>> map) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setTypeMap(map); return null; });
  }
  ...
  public void setHoldability(int holdability) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setHoldability(holdability); return null; });
  }
  ...
  public void rollback(Savepoint savepoint) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.rollback",
        () -> { this.currentConnection.rollback(savepoint); return null; });
  }
  ...
  public void releaseSavepoint(Savepoint savepoint) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.releaseSavepoint(savepoint); return null; });
  }
  ...
  public Statement createStatement(int resultSetType, int resultSetConcurrency,
    ...
    return WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.createStatement",
        () -> this.currentConnection.createStatement(resultSetType, resultSetConcurrency, resultSetHoldability));
  }
  ...
  public PreparedStatement prepareStatement(String sql, int resultSetType,
    ...
    return WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.prepareStatement",
        () -> this.currentConnection.prepareStatement(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
  }
  ...
  public CallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency,
    ...
    return WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.prepareCall",
        () -> this.currentConnection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability));
  }
  ...
  public void setClientInfo(String name, String value) throws SQLClientInfoException {
    WrapperUtils.executeWithPlugins_SQLClientInfoException(this.pluginManager,
        ...
        () -> { this.currentConnection.setClientInfo(name, value); return null; });
  }
  ...
  public void setClientInfo(Properties properties) throws SQLClientInfoException {
    WrapperUtils.executeWithPlugins_SQLClientInfoException(this.pluginManager,
        this.currentConnectionClass,
        "Connection.setClientInfo",
        () -> { this.currentConnection.setClientInfo(properties); return null; });
  }
  ...
  public void setSchema(String schema) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setSchema(schema); return null; });
  }
  ...
  public void abort(Executor executor) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        this.currentConnectionClass,
        "Connection.abort",
        () -> { this.currentConnection.abort(executor); return null; });
  }
  ...
  public void setNetworkTimeout(Executor executor, int milliseconds) throws SQLException {
    WrapperUtils.executeWithPlugins(this.pluginManager,
        ...
        () -> { this.currentConnection.setNetworkTimeout(executor, milliseconds); return null; });
  }
