...
public class WrapperUtils {
  ...
  public static synchronized <T> T executeWithPlugins_SQLClientInfoException(ConnectionPluginManager pluginManager,
      Class<?> methodInvokeOn, String methodName,
  ...
  protected static @Nullable <T> T wrapWithProxyIfNeeded(@Nullable T toProxy, ConnectionPluginManager pluginManager) {
    if (toProxy == null) {
      return null;
    }
