...
public class WriterFailoverResult {
   ...
   * @param topology      The Topology containing information about the available hosts
   * @param newConnection The current {@link Connection} object. This is null if there isn't a
   *                      current connection
   *                      and failover failed.
   */
